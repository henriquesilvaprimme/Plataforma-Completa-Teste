...
const Renovados = ({ leads, usuarios, onUpdateInsurer, onConfirmInsurer, onUpdateDetalhes, isAdmin, scrollContainerRef }) => {
    ...
    // NOVA FUNÇÃO: Formata um objeto Date para "DD/MM/AAAA HH:MM:SS"
                            ...
                            >
                                ...
                                <div className="col-span-1 border-b pb-4 lg:border-r lg:pb-0 lg:pr-6">
                                    ...
                                    <div className="space-y-1 text-sm text-gray-700">
                                        ...
                                        {/* Exibindo registeredAt formatado */}
                                        {lead.registeredAt && (
                                            <p><strong>Registrado em:</strong> {formatDateTime(lead.registeredAt)}</p>
                                        )}
                                        {/* Exibindo closedAt formatado (se existir) */}
                                        {lead.closedAt && (
                                            <p><strong>Fechado em:</strong> {formatDateTime(lead.closedAt)}</p>
                                        )}
                                    </div>
